...
public class PagarMeProvider {
    ...
    private static void validateSetup(TransactionSetup setup, boolean subset)
            throws FormatException {

        if (setup.getPaymentMethod().equals(PaymentMethod.credit_card)
                && Strings.isNullOrEmpty(setup.getCardhash()))
    ...
    public String generateCardHash(CreditCard creditCard)
            throws PagarMeException, FormatException, NoSuchAlgorithmException {
